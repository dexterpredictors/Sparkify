...
We achieved a validation F1 score equals to 0.78. For such a small dataset it's not bad at all. Also the fact we had only one false positive prediction is important.
